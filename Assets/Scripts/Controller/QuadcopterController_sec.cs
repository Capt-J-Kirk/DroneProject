...
public class QuadcopterController_sec: MonoBehaviour
{
    ...
    private Vector3 targetTranslation = new Vector3(0f, 0f, 0f);
    ...
    // set target translation value
    public void SetTargetTranslation(Vector3 value)
    {
        targetTranslation = value;
    }

    // set target rotation vakue
